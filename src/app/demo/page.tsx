...
const ComponentsDemo = () => {
  ...
  const mockPost = {
    ...
    author: mockUser,
    content:
      'Vừa hoàn thành một dự án React mới! Cảm ơn team đã hỗ trợ rất nhiều. 🚀\n\n#ReactJS #Frontend #TeamWork',
    images: [
  ...
  const mockComment = {
    ...
    author: {
      ...
      username: 'tranthib',
      avatar:
        'https://images.unsplash.com/photo-1494790108755-2616b73b6ac8?w=150&h=150&fit=crop&crop=face',
      verified: false,
    },
      ...
      <div className="max-w-4xl mx-auto px-4 space-y-8">
        ...
        >
          <p className="text-gray-600">
            This is an example modal with title, content, and footer. You can
            close it by clicking the X button, clicking outside, or pressing the
            Escape key.
          </p>
        </Modal>
      </div>
